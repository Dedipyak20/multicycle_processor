...
REM
REM Generated by Vivado on Sun Mar 29 15:51:38 +0530 2026
...
echo "xvlog --incr --relax -prj tb_multicycle_vlog.prj"
call xvlog  --incr --relax -prj tb_multicycle_vlog.prj -log xvlog.log
